...
public class ReimburseRepository {
    ...
    public List<Reimbursements> getAllReimbursements() throws SQLException{
        try(Connection connectionObj = ConnectionsFactory.createConnection()){
            ...
            while(rs.next()){
                ...
                Reimbursements reimbursement = new Reimbursements(id, amount, type, descrip, employeeId, managerId, status);
    ...
    public static Reimbursements addReimbursement(Reimbursements reimbursements) throws SQLException{
        ...
        try(Connection connectionObj = ConnectionsFactory.createConnection()){
            ...
            String sql = "INSERT into reimbursements (amount, reimbursement_type, reimbursement_descrip,employee_id ) values (?,?,?,?)";


            PreparedStatement pstmt = connectionObj.prepareStatement(sql);

            pstmt.setFloat(1,reimbursements.getAmount());
            pstmt.setString(2, reimbursements.getType());
            pstmt.setString(3,reimbursements.getdescription());
            pstmt.setInt(4,reimbursements.getEmployeeId()); //This currently must be manually entered.
            ...
            if(rs.next()){
                ...
                return new Reimbursements(id, reimbursements.getAmount(), reimbursements.getType(), reimbursements.getdescription(), reimbursements.getEmployeeId(), 0, "pending" );
            }else{
                return null;
            }
    ...
    public static Reimbursements getReimbursementById(int id) throws SQLException{
        try(Connection connectionObj = ConnectionsFactory.createConnection()){
            ...
            if(rs.next()){
                ...
                return new Reimbursements(reimbursementId, amount, type, descrip, employeeId, managerId, status);
            }else{
                return null;
            }
    ...
    public static List<Reimbursements> getReimbursementByStatus(String status) throws SQLException{
        try(Connection connectionObj = ConnectionsFactory.createConnection()){
            ...
            while(rs.next()){
                ...
                Reimbursements reimbursement = new Reimbursements(id, amount, type, descrip, employeeid, managerid, reimburse_status);
                reimbursements.add(reimbursement);
    ...
    public static List<Reimbursements> getReimbursementByType(String type) throws SQLException{
        try(Connection connectionObj = ConnectionsFactory.createConnection()){
            List<Reimbursements> reimbursements = new ArrayList<>();
            String sql = "SELECT * FROM reimbursements WHERE reimbursement_type = ?";
            ...
            while(rs.next()){
                int id = rs.getInt ("id");
                float amount = rs.getFloat("amount");
                String reType = rs.getString("reimbursement_type");
                String descrip = rs.getString("reimbursement_descrip");
                int employeeid = rs.getInt("employee_id");
                int managerid = rs.getInt("manager_id");
                String reimburse_status = rs.getString("status");

                Reimbursements reimbursement = new Reimbursements(id, amount, reType, descrip, employeeid, managerid, reimburse_status);
                reimbursements.add(reimbursement);
    ...
    public static List<Reimbursements> getReimbursementByTypeAndId(String type, int empId) throws SQLException{
        try(Connection connectionObj = ConnectionsFactory.createConnection()){
            List<Reimbursements> reimbursements = new ArrayList<>();
            String sql = "SELECT * FROM reimbursements WHERE reimbursement_type = ? AND employee_id = ?";
